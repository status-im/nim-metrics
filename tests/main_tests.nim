...
when defined(metrics):
  ...
  var
    myCustomCollector = MyCustomCollector.buildCollector("my_custom_collector", "help")
    registry2 = newRegistry()
    myCustomCollector2 = MyCustomCollector.buildCollector("my_custom_collector2", "help2", registry = registry2)
